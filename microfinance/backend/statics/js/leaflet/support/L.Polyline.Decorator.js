(function (global, factory) {
    ...
    */
    ...
    L$1.Symbol.Circle = L$1.Class.extend({
        options: {
            radius: 10,
            pathOptions: {}
        },
        ...
        buildSymbol: function buildSymbol(dirPoint, latLngs, map, index, total) {
            var opts = this.options;
            return L$1.circle(dirPoint.latLng, opts.radius, opts.pathOptions);
        }
    });

    L$1.Symbol.circle = function (options) {
        return new L$1.Symbol.Circle(options);
    };
